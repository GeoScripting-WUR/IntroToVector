...
pagetitle: "Week 2, Lesson 5: Intro to vector with R"
output:
...
# Week 2, Lesson 5: Intro to vector with R

## Today's learning objective

Learn how to handle vector data using R
...
The *sf* package focuses solely on vector data. It provides a standardized encoding of vector data and uses GDAL to read and write data, GEOS for geometrical operations and Proj for projection conversions and datum transformations.
